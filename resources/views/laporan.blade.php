                ...
                <form action="{{ route('report.report') }}" method="GET">
                    <div class="flex border border-[#389012] rounded-lg bg-[#389012]">
                        <div class="relative max-w-sm">
                            ...
                            <input id="date-filter" name="date_filter" type="text" placeholder="Select Week or Month" class="bg-[#389012] rounded-lg text-white text-sm focus:ring-[#389012] focus:border-[#389012] block w-full ps-10 p-2.5">
